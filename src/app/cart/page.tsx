          ...
          <li key={item.id} className="flex gap-4 py-5">
            ...
            <div className="flex flex-1 flex-col">
              ...
              <button
                ...
                className="mt-auto w-fit text-sm text-muted underline underline-offset-4 hover:text-accent"
              >
                Remove
              </button>
            </div>
      ...
      {enquiry ? (
        <div className="mt-6 rounded-lg border border-border bg-surface-muted p-5 text-sm">
          ...
          <Link
            ...
            className="mt-4 inline-block rounded-full bg-accent px-5 py-2.5 text-sm font-medium text-accent-contrast"
          >
            Send enquiry
          </Link>
        </div>
        ...
        <button
          ...
          className="mt-6 w-full rounded-full bg-accent px-6 py-3.5 text-sm font-medium text-accent-contrast transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
        >
          {busy
